...
GDD is designed to evolve through use, not just upfront design. The framework starts minimal and grows through a continuous feedback cycle.
...
This is GDD's 6th design principle: the initial implementation is deliberately minimal. Rather than designing the perfect framework upfront, GDD provides just enough structure to start capturing observations, then lets real usage reveal what's worth formalizing.
