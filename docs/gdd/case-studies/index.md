...
**What it shows:** the `ws` CLI and the portable layers (AGENTS.md, `ws orient`, skills-as-markdown) are the agent-neutral core — the [roadmap](../roadmap.md)'s cross-harness track is an extension of something already exercised, not just a hope.
