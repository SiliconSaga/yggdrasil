...
- [Features Tour](features.md) — what GDD ships: workspace, realms, hoards, components, bot review loop, stances, permissions, and 🆕 [sandboxed workspaces](features.md#sandboxed-workspaces-gdd-sandbox-optional-companion-new-in-11)
