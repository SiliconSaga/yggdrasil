...
It could be reworked later via the Tech Radar in Backstage? To see when Pulp might be a viable alternative, for instance.
...
*   **Tech Stack**: Backstage, Markdown, Static Site Generator (Hugo/Docusaurus?), GitHub Pages.
