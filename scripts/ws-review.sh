...
review_help() {
    ...
    echo "                             lags (it often does for minutes) it falls back to the"
    echo "                             head commit's check-suite creation time, then to all"
    echo "                             history with a NOTE — never to forgeable commit dates."
